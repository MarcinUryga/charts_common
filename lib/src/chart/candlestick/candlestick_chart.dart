...
import '../candlestick/candlestick_renderer.dart' show CandlestickRenderer;
...
class CandlestickChart extends OrdinalCartesianChart {
  CandlestickChart(
      {bool vertical,
  ...
  SeriesRenderer<String> makeDefaultRenderer() {
    return new CandlestickRenderer<String>()
