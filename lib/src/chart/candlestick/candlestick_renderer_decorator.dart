...
abstract class CandlestickRendererDecorator<D> {
  const CandlestickRendererDecorator();

  void decorate(Iterable<ImmutableCandlestickRendererElement<D>> barElements,
