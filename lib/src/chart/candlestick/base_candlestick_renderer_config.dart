...
import '../../common/symbol_renderer.dart' show SymbolRenderer, RoundedRectSymbolRenderer;
...
///   series.
abstract class BaseCandlestickRendererConfig<D> extends LayoutViewConfig
  ...
  final CandlestickGroupingType groupingType;

  /// The order to paint this renderer on the canvas.
  final int layoutPaintOrder;

  final int minCandlestickLengthPx;
  ...
  BaseCandlestickRendererConfig(
      {this.customRendererId,
      this.dashPattern,
      this.groupingType = CandlestickGroupingType.grouped,
      this.layoutPaintOrder,
      this.minCandlestickLengthPx = 0,
      this.fillPattern,
  ...
  bool get grouped =>
      ...
      groupingType == CandlestickGroupingType.groupedStacked;

  /// Whether or not the bars should be organized into stacks.
  bool get stacked =>
      groupingType == CandlestickGroupingType.stacked ||
      groupingType == CandlestickGroupingType.groupedStacked;
  ...
  bool operator ==(o) {
    ...
    if (!(o is BaseCandlestickRendererConfig)) {
      return false;
    }
    return o.customRendererId == customRendererId &&
        ...
        o.minCandlestickLengthPx == minCandlestickLengthPx &&
  ...
  int get hashcode {
    ...
    hash = hash * 31 + (minCandlestickLengthPx?.hashCode ?? 0);
...
enum CandlestickGroupingType { grouped, groupedStacked, stacked }
